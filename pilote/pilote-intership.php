...
<head>
	...
	<meta name="description" content="Page d'acceuil pilote pour les stages." />
    <!-- CSS -->
...
<header>
    ...
    <div class="a">
        ...
        <a href="./pilote-search-intership.php">Chercher des offres</a>
    </div>
    <div class="h">
        <h1>Des offres de stages proposées...</h1>
    </div>
   <div class="contener">
   <?php
                $server = 'localhost';
                ...
                try{
                    ...
                    foreach ($recipes as $recipe) {
                        ...
                        echo "<div class='al'>";
                        echo "<a href='./pilote-modif-intership.php?idinter=" . $recipe['id_intership'] . "'><img src='/assets/img/mod.png' alt='mod.png'></a>";
                        echo "<a href='./pilote-delete-intership.php?idinter=" . $recipe['id_intership'] . "'><img src='/assets/img/sup.png' alt='sup.png'></a>";
                        echo "<a href='./pilote-view-intership.php?idinter=" . $recipe['id_intership'] . "'><img src='/assets/img/next-step.png' alt='next.png'></a>";
                        echo "</div>";
                        echo "</div>";
                    }
                    $conn=null;
