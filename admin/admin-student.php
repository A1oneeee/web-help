...
<br>
<footer><button> <a href="http://localhost/étudiant/prjv1phpdel.php">Cliquez ici pour supprimer un étudiant</button>
        <button> <a href="http://localhost/étudiant/prjv1phpsee.php">Cliquez ici pour voir les étudiants</button>
        <button> <a href="http://localhost/étudiant/prjv1phpup.php">Cliquez ici pour modifier un étudiant</button>
